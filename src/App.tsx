...
import { FileDown, RefreshCw, Loader2, Play, Download, Package, AlertTriangle, ArrowLeft, HardDrive } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-600 text-lg">
            Securely split large CSV files in your browser. No upload required.
          </p>
          <p className="text-sm text-green-600 font-medium">
            ✓ Supports files up to 10GB+ • 100% Client-Side • Zero Server Upload
          </p>
        </div>
